...
<section id="bo_w">
	...
	<div class="form-group">
	    ...
	    <select name="ca_name" id="ca_name" class="form-control">
	...
	<div class="form-group">
		...
		<div class="custom-file">
			<input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="bf_file[]">
			<label class="custom-file-label" for="f_file[]">파일 #<?php echo $i+1 ?></label>
		</div>
